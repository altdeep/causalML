...
> If p value is below a .05 significance threshold, conclude that the conditional independence statement is true.  Otherwise conclude it is false.
...
Use the rejection sampling inference procedure you used to estimate $P(A = on\ | \  B = on, C = on)$ to now estimate $P(A = on\ | \  \text{do}(B = on0, C = on)$.  
