...
## 2.2
You are a data scientist investigating the effects of social media use on conversions/purchase.
You assume the dag shown below. User context here is unobserved. One of the team members argue that social media usage does not drive conversions based on the data in Table 1. Only 15% of the conversions is attributed to social media usage and the conversion rate is higher among those who are not active on social media. However another team member argues that social media usage increases conversion when we look at ad-exposure levels in each groups (Table 2). 95% of the users active on social media are exposed to ads whereas only 5% of the  non-active users see ads. 15% of these users exposed to ads result in conversion as compared to 10% of those without ad exposure. Among the non-active users , 95% users with exposure to ads end up purchasing.
...
\hline
& \multicolumn{2}{|c|}{no ad-block (50\%)} & \multicolumn{2}{|c|}{ad-block (50\%)} & \multicolumn{2}{|c|}{all subjects(800)} \\
\hline
& sociale & no social & sociale & no social & sociale & no social \\
\hline
...
\hline
& no ad-block & ad-block & no ad-block & ad-block & no ad-block & ad-block \\
\hline
Total & 380 & 20 & 20 & 380 & 400 & 400 \\
No Conversion & 323 (85\%) & 1 (5\%) & 18 (90\%) & 38 (10\%) & 341 (85.25\%) & 39 (9.75\%) \\
Conversion & 57 (15\%) & 19(95\%) & 2 (10\%)  & 342 (90\%) & 59 (14.75\%) & 361 (90.25\%) \\
...
### 2.2.a
User context is unobserved.  Use `pyro.condition` to calculate the causal effect of social media on conversions using front-door adjustment (Section 3.4 in [Front Door Criterion](http://bayes.cs.ucla.edu/PRIMER/primer-ch3.pdf)).(5 points) 
