...
## 3.3
List all possible combinations of X, Y, Z and get the probability of each combination. Hint: Use your `propensity` function, create a list of weights for each sample $i$, by multiplying the sample's probability by $1 / P(X = x_i | Z = z_i)$. (3 points)
