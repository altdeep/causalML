...
* Compute and plot PDAG of the DAG for the survey data using the `cpdag` function.
* Create a DAG that is different from your original DAG but is in the same Markov equivalence class. Plot it.
* For each graph, calculate the log-likelihood of the data using the `score` function.  Explain how the scores compare to one another.
